package PatternMatching.bruteforce;

import java.util.Arrays;

/**
 * Brute Force Algorithm<BR>
 *     It will search for a pattern into an array and if the pattern if found it will
...
public class bruteforce {
     ...
     * @return a index of first pattern
     */
     ...
     * @param array character array
     * @param pattern character array
     * @return integer array, elements found
     */
